...
public class DiagnoseWebClientConfig {

    private final LoadBalancedExchangeFilterFunction filterFunction;

    public WebClient diagnoseWebClient() {
    ...
    @Bean
    public DiagnoseClient diagnoseClient() {
        HttpServiceProxyFactory httpServiceProxyFactory
                = HttpServiceProxyFactory
                .builder(WebClientAdapter.forClient(diagnoseWebClient()))
                .build();
        return httpServiceProxyFactory.createClient(DiagnoseClient.class);
    }
